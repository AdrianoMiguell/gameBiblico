...
<body>
    <main>
        <div class="position-absolute top-0 d-flex justify-content-between align-items-center w-100 p-2">
            ...
            <?php if (!isset($email)) : ?>
                <a href='<?php echo $folderPages; ?>/login.php' id='linkUser' class='btnG'> login </a>
            <?php else : ?>
                <div class="btn-group">
                    ...
                    <ul id="divUserNav" class="dropdown-menu">
                        <div>
                            <div>
                                <a href='<?php echo $folderRegst; ?>/profile.php' id='linkUser'> profile
                            </div>
                            </a>
                            <a href='<?php echo $folderRegst; ?>/logout.php' id='linkUser'>
                                <div>logout</div>
                            </a>
                        </div>
                    </ul>
